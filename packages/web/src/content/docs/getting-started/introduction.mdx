...
LWC Garden aims to be a replacement for the official Salesforce [`@salesforce/lwc-dev-server`](https://www.npmjs.com/package/@salesforce/lwc-dev-server), which has not received an update since 2021 and won't likely recieve anything [until 2025](https://github.com/forcedotcom/salesforcedx-vscode/issues/5501).
