...
{/* prettier-ignore */}
export const gardenConfigJs = `import lwrConfig from './lwr.config.json' assert { type: 'json' }
...
<Aside>
On windows, certain `lightning-base-components` do not work. This is a known issue with the LWR runtime.
</Aside>
