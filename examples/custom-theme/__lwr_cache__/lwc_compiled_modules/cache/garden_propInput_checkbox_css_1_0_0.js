...
function stylesheet(token, useActualHostSelector, useNativeDirPseudoclass) {
  ...
  return "[role='fieldset']" + shadowSelector + " {border: none;padding: 0;margin: 0;}.options" + shadowSelector + " {display: flex;}[data-type='checkbox']" + shadowSelector + " .options" + shadowSelector + " {flex-direction: column;}[data-type='inline-checkbox']" + shadowSelector + " .options" + shadowSelector + " {flex-direction: row;flex-wrap: wrap;}.options" + shadowSelector + " label" + shadowSelector + " {padding: 4px 0;display: flex;cursor: pointer;}.options" + shadowSelector + " > span" + shadowSelector + " {display: flex;}[data-type='inline-checkbox']" + shadowSelector + " .options" + shadowSelector + " label" + shadowSelector + " {padding: 0 4px;}";
  /*LWC compiler v6.5.0*/
}
